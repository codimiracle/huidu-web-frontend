...
export interface AwaitingPaymentState {
  hasMore: boolean,
  loading: boolean,
  page: number,
  limit: number,
...
export default class AwaitingPayment extends React.Component<AwaitingPaymentProps, AwaitingPaymentState> {
  constructor(props: AwaitingPaymentProps) {
    super(props);
    this.state = {
      page: 1,
      limit: 10,
